...
rustPlatform.buildRustPackage rec {
  pname = "neovide";
  version = "e484c906cd134bc31375f849d4c222d024a976e5";

  src = fetchFromGitHub {
    owner = "Kethku";
    repo = "neovide";
    rev = version;
    sha256 = "sha256-mBuNNJSqabTEJ6wTVbzXPSZAGtJjWW3rg/9HBoepBYk=";
  };

  cargoSha256 = "sha256-F+cFxv3y0E2I1nKiqX76XLCAJyVRU8WEb4HhJ83FsHQ=";
  ...
  ] ++ lib.optionals stdenv.isDarwin (with darwin; with apple_sdk.frameworks; [ Security ApplicationServices Carbon AppKit ]);
  ...
  meta = with lib; {
    description = "This is a simple graphical user interface for Neovim. (Unreleased version, I use this to work around #992)";
